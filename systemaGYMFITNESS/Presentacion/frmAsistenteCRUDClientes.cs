...
{
    public partial class frmAsistenteCRUDClientes : Form
    {
        int estado;
        public frmAsistenteCRUDClientes()
        {
            InitializeComponent();
            estado = 1;
        }
        ...
        private void FrmAsistenteCRUDClientes_Load(object sender, EventArgs e)
        {
        ...
        {
            frmAsisenciaCliente frm = new frmAsisenciaCliente();
            frm.ShowDialog();
        }
    }
}
